...
OUTPUT = mini-os/boot/kernel.bin
...
build:all
	...
	rm mini-os/boot/grub/ -r -f
	mkdir mini-os/boot/grub/
	echo set default=0 >> mini-os/boot/grub/grub.cfg
	echo set timeout=0 >> mini-os/boot/grub/grub.cfg
	echo menuentry "mini-os" { >> mini-os/boot/grub/grub.cfg
	echo         set root='(hd96)' >> mini-os/boot/grub/grub.cfg
	echo         multiboot /boot/kernel.bin >> mini-os/boot/grub/grub.cfg
	echo } >> mini-os/boot/grub/grub.cfg

	grub-mkrescue -o mini-os.iso mini-os/
